(function() {
  ...
  var firstVideoScene, secondVideoScene, thirdVideoScene, fourthVideoScene, wallVideoScene;

  var stickyMenu,
    stickyMenuLogo,
    stickyMenuBlackClass,
    winder,
    firstInfoParagraphIn,
    firstInfoParagraphOut,
    firstTextPin,
    lightOn,
    winderCenterAnimation,
    startWinderParallax,
    winderStopPosition,
    secondTextPin,
    secondInfoParagraphIn,
    secondInfoParagraphOut,
    standAnimation,
    removeTopSection,
    addEmptyWinderToTop,
    startWinderSlider,
    sliderDescriptions,
    sliderDescriptionsClasses,
    firstSlideAnimation,
    firstSlideAnimationOut,
    firstSlideZIndex,
    secondSlideAnimationImage,
    bigStandFadeOut,
    firstVideoScene,
    firstSlideAnimationImageOut,
    firstSlideZIndexOut,
    secondSlideZIndex,
    wallVideoScene,
    secondSlideAnimation,
    secondSlideAnimationImage,
    secondSlideAnimationImageOut,
    secondSlideZIndexOut,
    thirdSlideZIndex,
    thirdSlideAnimation,
    thirdSlideAnimationImage,
    secondVideoScene,
    thirdSlideAnimationImageOut,
    thirdSlideZIndexOut,
    fourthSlideZIndexIn,
    fourthSlideAnimation,
    fourthSlideAnimationImage,
    thirdVideoScene,
    fourthSlideAnimationImageOut,
    fourthlideZIndexOut,
    fifththSlideZIndexOut,
    fifthSlideAnimation,
    fifthSlideAnimationImage,
    fifthImageRealWinderFadeIn,
    fourthVideoScene,
    fifthSlideAnimationImageOut,
    fifthlideZIndexOut,
    lastWinderCenter,
    lastWinderCenterScale,
    bottomDescription1,
    bottomDescription2,
    bottomDescription3,
    bottomDescription1WinderWinder,
    bottomDescription1,
    bottomDescription1Out,
    bottomDescription1Out,
    bottomDescription2WinderWinder,
    bottomDescription2,
    bottomDescription2Out,
    bottomDescription2OutOpacity,
    bottomDescription3WinderWinder,
    bottomDescription3WinderWatch,
    bottomDescription3,
    bottomDescription3Out,
    bottomDescription3Out,
    bottomWinderCenter,
    bottomDescription3OutOpacity,
    bottomWinderStandFade,
    bottomWinderOriginalFadeOut,
    bottomWinderOriginalFadeOut,
    bottomWinderScaleUp,
    fulhaberMotorSection,
    fulhaberMotorScroll,
    lastWinder,
    fulhaberDescription,
    mockupAppTween,
    specsSection,
    appMockupFirstTextPin,
    appMockupFirstText,
    appMockupFirstTextOut,
    appMockupFirstTextPin2,
    appMockupFirstText2,
    appMockupFirstTextOut2,
    appMockupFirstTextPin3,
    appMockupFirstText3,
    appMockupFirstTextOut3;
  ...
  stickyMenu = new ScrollMagic.Scene({ triggerElement: '.section-second-info', offset: stickyMenuOffset, duration: 60 })
  ...
  stickyMenuLogo = new ScrollMagic.Scene({ triggerElement: '.section-second-info', offset: stickyMenuOffset, duration: 60 })
    .setTween(stickyMenuLogoTween)
    // .addIndicators({name: 'Sticky Menu Logo'})
    .addTo(controller);

  stickyMenuBlackClass = new ScrollMagic.Scene({ triggerElement: '.section-second-info', offset: stickyMenuOffset })
  ...
  firstInfoParagraphIn = new ScrollMagic.Scene({
    triggerElement: '.single-break',
    triggerHook: 0,
    duration: 200,
  ...
  firstInfoParagraphOut = new ScrollMagic.Scene({
    triggerElement: '.single-break',
    triggerHook: 0,
    duration: 200,
  ...
  var firstTextPin = -200;
  
  if (windowHeight < 800) {
    firstTextPin = 0;
  }

  firstTextPin = new ScrollMagic.Scene({
    triggerElement: '.single-break',
    triggerHook: 0,
    duration: 1780,
    offset: firstTextPin + firstTextOffset,
  })
    .setPin('.extra-info-paragraph')
    // .addIndicators({name: 'first text pin'})
    .addTo(controller);

  lightOn = new ScrollMagic.Scene({triggerElement: '.single-break', duration: 250})
  ...
  winderCenterAnimation = new ScrollMagic.Scene({triggerElement: '.single-break', duration: 5610})
  ...
  startWinderParallax = new ScrollMagic.Scene({triggerElement: '.start-parallax-winder-section', duration: 500})
  ...
  winderStopPosition = new ScrollMagic.Scene({triggerElement: '.start-parallax-winder-stop-section', duration: winderStopPositionDuration, offset: firstWinderOffset})
                          .setPin('.main-winder')
                          // .addIndicators({name: 'neki'})
                          .addTo(controller);
  
  secondTextPin = new ScrollMagic.Scene({duration: 10000})
  ...
  secondInfoParagraphIn = new ScrollMagic.Scene({triggerElement: '.start-second-info', duration: 200})
    .setTween(secondInfoParagraphInTween)
    // .addIndicators({name: 'second text in'})
    .addTo(controller);

  secondInfoParagraphOut = new ScrollMagic.Scene({triggerElement: '.start-second-info', duration: 200, offset: 1540})
  ...
  standAnimation = new ScrollMagic.Scene({triggerElement: '.start-winder-stand-remove', duration: 300, offset: 1300})
                        .setTween(standTween)
                        .addTo(controller);
  ...
  removeTopSection = new ScrollMagic.Scene({triggerElement: '.remove-top-stand-section', duration: 500})
                        .setTween(standRemoveTween)
                        // .addIndicators({name: 'removeTopSection'})
                        .addTo(controller);

  addEmptyWinderToTop = new ScrollMagic.Scene({triggerElement: ".remove-top-stand-section", duration: 0})
                          .setClassToggle('.top-one-empty', 'stand-without-top-one--visible')
                          
                          .addTo(controller);
  
  startWinderSlider = new ScrollMagic.Scene({triggerElement: '.single-break', offset: 7748, duration: 700 })
    .setPin('.stand-without-top-one--desktop')
    // .addIndicators({name: 'startWinderSlider'})
    .addTo(controller);

  sliderDescriptions = new ScrollMagic.Scene({duration: 28000})
    .setPin('.slider-descriptions')
    // .addIndicators({name: 'descriptions'})
    .addTo(controller);

  sliderDescriptionsClasses = new ScrollMagic.Scene({triggerElement: '.single-break', duration: 22000, offset: 7700})
  ...
  firstSlideAnimation = new ScrollMagic.Scene({triggerElement: '.single-break', offset: 7900, duration: 250 })
  ...
  firstSlideAnimationOut = new ScrollMagic.Scene({triggerElement: '.single-break', offset: 7748, duration: 550 })
  ...
  firstSlideZIndex = new ScrollMagic.Scene({triggerElement: '.single-break', offset: 8130 })
  ...
  secondSlideAnimationImage = new ScrollMagic.Scene({triggerElement: '.single-break', offset: 8280, duration: 100 })
  ...
  bigStandFadeOut = new ScrollMagic.Scene({triggerElement: '.single-break', offset: 8400, duration: 20 })
    .setTween(bigStandFadeOutTween)
    // .addIndicators({name: 'Big Stand Removed'})
    .addTo(controller);

  firstVideoScene = new ScrollMagic.Scene({ triggerElement: '.single-break', offset: 8260, duration: 2300 })

  var firstSlideSimageOut = new TimelineMax()
    .add(TweenMax.fromTo('.slider__1', { opacity: 1 }, { opacity: 0, immediateRender: false }));
  
  firstSlideAnimationImageOut = new ScrollMagic.Scene({triggerElement: '.single-break', offset: 10500, duration: 200 })
  ...
  firstSlideZIndexOut = new ScrollMagic.Scene({triggerElement: '.single-break', offset: 10700 })
  ...
  secondSlideZIndex = new ScrollMagic.Scene({triggerElement: '.single-break', offset: 10800 })
    .setTween(secondSlideZIndexTween)
    // .addIndicators({name: 'Second Slide In'})
    .addTo(controller);

  wallVideoScene = new ScrollMagic.Scene({ triggerElement: '.single-break', offset: 10800, duration: 2500 });
  ...
  secondSlideAnimation = new ScrollMagic.Scene({triggerElement: '.single-break', offset: 10800, duration: 200 })
    .setTween(secondSlideBodyIn)
    // .addIndicators({name: 'Slider 2 Content Fade In'})
    .addTo(controller);

  secondSlideAnimationImage = new ScrollMagic.Scene({triggerElement: '.single-break', offset: 10800, duration: 300 })
  ...
  secondSlideAnimationImageOut = new ScrollMagic.Scene({triggerElement: '.single-break', offset: 13200, duration: 200 })
  ...
  secondSlideZIndexOut = new ScrollMagic.Scene({triggerElement: '.single-break', offset: 13400 })
  ...
  thirdSlideZIndex = new ScrollMagic.Scene({triggerElement: '.single-break', offset: 13500 })
  ...
  thirdSlideAnimation = new ScrollMagic.Scene({triggerElement: '.single-break', offset: 13500, duration: 200 })
    .setTween(thirdSlideBodyIn)
    // .addIndicators({name: 'slide #3'})
    .addTo(controller);

  thirdSlideAnimationImage = new ScrollMagic.Scene({triggerElement: '.single-break', offset: 13500, duration: 200 })
    .setTween(thirdSlideSimageIn)
    // .addIndicators({name: 'slide #3 image in'})
    .addTo(controller);

  secondVideoScene = new ScrollMagic.Scene({ triggerElement: '.single-break', offset: 13500, duration: 2300 })


  var thirdSlideSimageOut = new TimelineMax()
    .add(TweenMax.fromTo('.slider__3', { opacity: 1 }, { opacity: 0, immediateRender: false }));
  
  thirdSlideAnimationImageOut = new ScrollMagic.Scene({triggerElement: '.single-break', offset: 15700, duration: 200 })
  ...
  thirdSlideZIndexOut = new ScrollMagic.Scene({triggerElement: '.single-break', offset: 15900 })
  ...
  fourthSlideZIndexIn = new ScrollMagic.Scene({triggerElement: '.single-break', offset: 16000 })
  ...
  fourthSlideAnimation = new ScrollMagic.Scene({triggerElement: '.single-break', offset: 16000, duration: 200 })
    .setTween(fourthSlideBodyIn)
    // .addIndicators({name: 'Slide 4 In'})
    .addTo(controller);

  fourthSlideAnimationImage = new ScrollMagic.Scene({triggerElement: '.single-break', offset: 16000, duration: 200 })
    .setTween(fourthSlideSimageIn)
    // .addIndicators({name: 'slide #4 image in'})
    .addTo(controller);

  thirdVideoScene = new ScrollMagic.Scene({ triggerElement: '.single-break', offset: 16000, duration: 2300 });

  var fourthSlideSimageOut = new TimelineMax()
    .add(TweenMax.fromTo('.slider__4', { opacity: 1 }, { opacity: 0, immediateRender: false }));
  
  fourthSlideAnimationImageOut = new ScrollMagic.Scene({triggerElement: '.single-break', offset: 18100, duration: 200 })
  ...
  fourthlideZIndexOut = new ScrollMagic.Scene({triggerElement: '.single-break', offset: 18300 })
  ...
  fifththSlideZIndexOut = new ScrollMagic.Scene({triggerElement: '.single-break', offset: 18400 })
  ...
  fifthSlideAnimation = new ScrollMagic.Scene({triggerElement: '.single-break', offset: 18400, duration: 200 })
    .setTween(fifthSlideBodyIn)
    // .addIndicators({name: 'slide #5'})
    .addTo(controller);

  fifthSlideAnimationImage = new ScrollMagic.Scene({triggerElement: '.single-break', offset: 18400, duration: 300 })
  ...
  fifthImageRealWinderFadeIn = new ScrollMagic.Scene({triggerElement: '.single-break', duration: 20, offset: 20710})
    .setTween(fifthImageRealWinderFadeInTween)
    // .addIndicators({name: 'fifthImageRealWinderFadeIn'})
    .addTo(controller);

  fourthVideoScene = new ScrollMagic.Scene({ triggerElement: '.single-break', offset: 18400, duration: 2300 });
  ...
  fifthSlideAnimationImageOut = new ScrollMagic.Scene({triggerElement: '.single-break', offset: 20800, duration: 200 })
  ...
  fifthlideZIndexOut = new ScrollMagic.Scene({triggerElement: '.single-break', offset: 21000 })
  ...
  lastWinderCenter = new ScrollMagic.Scene({triggerElement: '.single-break', offset: 21000, duration: 400 })
    .setTween(lastWinderCenterTween)
    // .addIndicators({name: 'center last winder'})
    .addTo(controller);

  lastWinderCenterScale = new ScrollMagic.Scene({triggerElement: '.single-break', offset: 21000, duration: 400 })
    .setTween(lastWinderCenterWinderTween)
    // .addIndicators({name: 'center last winder scale'})
    .addTo(controller);

  bottomDescription1 = new ScrollMagic.Scene({triggerElement: '.single-break', duration: 26000, triggerHook: 1})
    .setPin('.winder-bottom-description__1')
    .addTo(controller);

  bottomDescription2 = new ScrollMagic.Scene({triggerElement: '.single-break', duration: 26000, triggerHook: 1})
    .setPin('.winder-bottom-description__2')
    .addTo(controller);

  bottomDescription3 = new ScrollMagic.Scene({triggerElement: '.single-break', duration: 26000, triggerHook: 1})
  ...
  bottomDescription1WinderWinder = new ScrollMagic.Scene({triggerElement: '.single-break', offset: 21500, duration: 250 })
  ...
  bottomDescription1 = new ScrollMagic.Scene({triggerElement: '.single-break', offset: 21500, duration: 250 })
  ...
  bottomDescription1Out = new ScrollMagic.Scene({triggerElement: '.single-break', offset: 22200, duration: 250 })
  ...
  bottomDescription2WinderWinder = new ScrollMagic.Scene({triggerElement: '.single-break', offset: 22600, duration: 250 })
  ...
  bottomDescription2 = new ScrollMagic.Scene({triggerElement: '.single-break', offset: 22600, duration: 250 })
  ...
  bottomDescription2Out = new ScrollMagic.Scene({triggerElement: '.single-break', offset: 23500, duration: 250 })
  ...
  bottomDescription2OutOpacity = new ScrollMagic.Scene({triggerElement: '.single-break', offset: 23500, duration: 250 })
  ...
  bottomDescription3WinderWinder = new ScrollMagic.Scene({triggerElement: '.single-break', offset: 23850, duration: 250 })
  ...
  bottomDescription3WinderWatch = new ScrollMagic.Scene({triggerElement: '.single-break', offset: 23850, duration: 250})
  ...
  bottomDescription3 = new ScrollMagic.Scene({triggerElement: '.single-break', offset: 23850, duration: 250 })
  ...
  bottomDescription3Out = new ScrollMagic.Scene({triggerElement: '.single-break', offset: 24700, duration: 250 })
  ...
  bottomWinderCenter = new ScrollMagic.Scene({triggerElement: '.single-break', offset: 25200, duration: 750})
  ...
  bottomDescription3OutOpacity = new ScrollMagic.Scene({triggerElement: '.single-break', offset: 25000, duration: 250 })
  ...
  bottomWinderStandFade = new ScrollMagic.Scene({triggerElement: '.single-break', offset: 26000, duration: 100 })
    .setTween(bottomWinderStandFadeTween)
    // .addIndicators({name: 'winder fade in'})
    .addTo(controller);

  bottomWinderOriginalFadeOut = new ScrollMagic.Scene({triggerElement: '.single-break', offset: 26100})
    .setClassToggle('.slider__5', 'slider__5--winder-hidden')
    // .addIndicators({name: 'Original fade out In'})
    .addTo(controller);

  bottomWinderOriginalFadeOut = new ScrollMagic.Scene({triggerElement: '.single-break', offset: 26500})
    .setClassToggle('.slider__5', 'slider__5--hide-overflow')
    // .addIndicators({name: 'Original fade out In'})
    .addTo(controller);

  bottomWinderScaleUp = new ScrollMagic.Scene({triggerElement: '.single-break', offset: 26000, duration: 550})
  ...
  fulhaberMotorSection = new ScrollMagic.Scene({triggerElement: '.empty-section--fade-in', duration: 50, offset: 500})
    .setTween(fulhaberMotorSectionTween)
    // .addIndicators({name: 'fulhaber motor fade in'})
    .addTo(controller);

  fulhaberMotorScroll = new ScrollMagic.Scene({triggerElement: '.empty-section--fade-in', duration: 800, offset: 850})
    .setTween('.fulhaber-motor-image-description-wrapper', {y: "80%", ease: Linear.easeNone})
    // .addIndicators({name: 'fulhaber scroll'})
    .addTo(controller);

  lastWinder = new ScrollMagic.Scene({triggerElement: '.empty-section--fade-in', duration: 600, offset: 1100})
    .setPin('.fulhaber-motor-image')
    // .addIndicators({name: 'pin fulhaber-motor-image'})
    .addTo(controller);

  fulhaberDescription = new ScrollMagic.Scene({triggerElement: '.empty-section--fade-in', duration: 700, offset: 1000})
    .setClassToggle('.fulhaber-motor-image-description', 'in-viewport')
    // .addIndicators({name: 'ful haber description'})
    .addTo(controller);

  mockupAppTween = new ScrollMagic.Scene({triggerElement: ".app-mockup-section", duration: 3500, offset: 0})
    .setTween('.app-mockup', {y: "50%", ease: Linear.easeNone})
    // .addIndicators({name: 'mockup scroll'})
    .addTo(controller);

  specsSection = new ScrollMagic.Scene({triggerElement: ".specs-section", duration: 1800, offset: 0})
   ...
   * first text
   */
  appMockupFirstTextPin = new ScrollMagic.Scene({triggerElement: ".app-mockup-section", duration: appMockupsDuration, offset: 650})
  ...
  appMockupFirstText = new ScrollMagic.Scene({triggerElement: '.app-mockup-text-section--first', duration: 150, offset: 220, ease: Linear.easeNone })
  ...
  appMockupFirstTextOut = new ScrollMagic.Scene({triggerElement: '.app-mockup-text-section--first', duration: 150, offset: 750, ease: Linear.easeNone })
   ...
   * second text
   */
  appMockupFirstTextPin2 = new ScrollMagic.Scene({triggerElement: ".app-mockup-section", duration: appMockupsDuration, offset: 1500})
  ...
  appMockupFirstText2 = new ScrollMagic.Scene({triggerElement: '.app-mockup-text-section--second', duration: 150, offset: 150, ease: Linear.easeNone })
  ...
  appMockupFirstTextOut2 = new ScrollMagic.Scene({triggerElement: '.app-mockup-text-section--second', duration: 150, offset: 737, ease: Linear.easeNone })
   ...
   * third text
   */
  appMockupFirstTextPin3 = new ScrollMagic.Scene({triggerElement: ".app-mockup-section", duration: appMockupsDuration, offset: 2300})
  ...
  appMockupFirstText3 = new ScrollMagic.Scene({triggerElement: '.app-mockup-text-section--third', duration: 150, offset: 150, ease: Linear.easeNone })
  ...
  appMockupFirstTextOut3 = new ScrollMagic.Scene({triggerElement: '.app-mockup-text-section--third', duration: 150, offset: 700, ease: Linear.easeNone })
  ...
  window.addEventListener('resize', debounce(function() {
    ...
    for (var scene of scrollMagicScenes) {
      if (scene) {
        scene.destroy(true);
      }
    }
